    ...
    <section id="home" role="region" aria-labelledby="hero-heading">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold">Kim Robinson</h1>
          <p className="text-[#ADB7BE] text-base sm:text-lg lg:text-xl mb-6">words and stuff and things....</p>
          <div>
